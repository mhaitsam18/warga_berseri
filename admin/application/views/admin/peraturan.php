    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="" class="btn btn-primary mb-3 newPeraturanModalButton" data-toggle="modal" data-target="#newPeraturanModal">Tambah Peraturan Baru</a>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($peraturan as $key): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?= base_url('assets/img/peraturan/').$key['thumbnail'] ?>" class="img-thumbnail" style="width: 300px;"></td>
                                        <td>
                                            <a href="<?= base_url("Admin/updatePeraturan/$key[id]"); ?>" class="badge badge-success updatePeraturanModalButton" data-toggle="modal" data-target="#newPeraturanModal" data-id="<?=$key['id']?>">Edit</a>
                                            <a href="<?= base_url("Admin/deletePeraturan/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php $no++; ?>
                                <?php endforeach ?>
...
<div class="modal fade" id="newPeraturanModal" tabindex="-1" aria-labelledby="newPeraturanModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('Admin/peraturan') ?>" method="post" enctype="multipart/form-data">
