                            ...
                            <tbody>
                                ...
                                <?php foreach ($pengumuman as $key): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?= base_url('assets/img/pengumuman/').$key['thumbnail'] ?>" class="img-thumbnail" style="width: 300px;"></td>
                                        <td>
                                            <a href="<?= base_url("Admin/updatePengumuman/$key[id]"); ?>" class="badge badge-success updatePengumumanModalButton" data-toggle="modal" data-target="#newPengumumanModal" data-id="<?=$key['id']?>">Edit</a>
                                            <a href="<?= base_url("Admin/deletePengumuman/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php $no++; ?>
                                <?php endforeach ?>
...
<div class="modal fade" id="newPengumumanModal" tabindex="-1" aria-labelledby="newPengumumanModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('Admin/pengumuman') ?>" method="post" enctype="multipart/form-data">
