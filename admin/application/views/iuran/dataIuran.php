...
<div class="container-fluid">
   <div class="card shadow mb-4">
     <div class="card-header py-3">
      <h4 style="float: left;">Data Pembayaran Iuran</h4><a href="<?php echo base_url(); ?>IuranController/tambah_iuran" style ="float: right;"><h6 class="m-0 font-weight-bold text-primary"> <input class="btn btn-primary" type="submit" value=" Tambah Data Iuran +"></a></h6>
     </div>
     <div class="card-body">
         ...
         <tbody>
          ...
          foreach($iuran as $f) { ?>
             <tr>
              ...
              <td><?php echo $f->tanggal_pembayaran; ?></td>
              <td><img src="http://localhost/warga_berseri/<?php echo $f->bukti_pembayaran;?>"></td>
              <td> <a href="<?php echo base_url(); ?>IuranController/verifikasi_iuran/<?php echo $f->no_tagihan; ?>"><button type="button">Verifikasi Iuran</button></a></td>
              </tr>
          <?php } ?>
        </tbody>
        </table>
