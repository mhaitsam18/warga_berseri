...
<div class="container-fluid">
   <div class="card shadow mb-4">
     <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary"> <form enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>Dashboard/create"> <input class="btn btn-primary" type="submit" value=" Tambah Data +"> </form> </h6>
     </div>
     <div class="card-body">
         ...
         <tbody>
          ...
          foreach($data_fasilitas as $f) { ?>
             <tr>
              ...
              <td style="width: 150px"><img src="<?php echo $f->foto_lokasi; ?>" width="150px" height="100px"></td>
              <td style="width: 200px"><?php echo $f->nama_lokasi ?></td>
              <td><?php echo $f->alamat_lokasi ?></td>
              <td><?php echo $f->fasilitas_lokasi ?></td>
              <td> <a href="<?= base_url('Dashboard/edit/'.$f->no) ?>" class="btn btn-sm btn-success"> <i class="fa fa-pen"> <i> </td>
              <td> <a href="<?= base_url('Dashboard/delete/'.$f->no) ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> </a> </td>
              </tr>
          <?php } ?>
        </tbody>
        </table>
