     ...
     <div class="card-body">
       <div class="text-center">
        ...
        <thead>
         ...
         <tbody>
          <?php $no=1;
          foreach($penggunaan as $f) { ?>
             <tr>
              <th scope="row"> <?php echo $no++ ?></th>
              <td> <?php echo $f->nama_kebutuhan; ?></td>
              <td ><?php echo $f->jumlah_pengeluaran; ?></td>
              <td><?php $tanggal =  strtotime($f->tanggal_penggunaan);
                    echo date('d-M-Y',$tanggal); ?></td>
              <td><img src="http://localhost/warga_berseri/<?php echo$f->bukti_pengeluaran;?>"></td>
              <td><?php echo $f->keterangan; ?></td>
              <td><a href="<?php echo base_url(); ?>IuranController/edit_data_penggunaan/<?php echo $f->id_penggunaan; ?>"><button class="btn-primary">Edit <i class="far fa-edit"></i></button></a> <a href="<?php echo base_url(); ?>IuranController/hapus_data_penggunaan/<?php echo $f->id_penggunaan; ?>"><button class="btn-primary">Hapus <i class="fa fa-trash"></i></button></a></td>
              </tr>
          <?php } ?>
        </tbody>
        </table>
