...
<footer class="footer">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        2020 &copy; PBB <a href="#">Warga Berseri</a>
      </div>
      <!-- <div class="col-md-6">
...
<script type="text/javascript">
        ...
        $(function() {
            $('.newMenuModalButton').on('click', function(){
                ...
                $('.modal-content form').attr('action', 'http://localhost/warga_berseri/admin/menu');
            });

            $('.updateMenuModalButton').on('click', function() {
                $('#newMenuModalLabel').html('Edit Menu');
                $('.modal-footer button[type=submit]').html('Save');
                $('.modal-content form').attr('action', 'http://localhost/warga_berseri/admin/menu/updateMenu');
                const id = $(this).data('id');
                jQuery.ajax({
                    url: 'http://localhost/warga_berseri/admin/menu/getUpdateMenu',
                    data: {id : id},
                    method: 'post',
                    dataType: 'json',
            ...
            $('.detailKeluhanModalButton').on('click', function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#bukti_keluhan').attr('src',"<?=base_url2('assets/img/keluhan-aspirasi/') ?>"+data.bukti);
                    }
                });
            });
        });
            ...
            $('.detailAspirasiModalButton').on('click', function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#bukti_aspirasi').attr('src',"<?=base_url2('assets/img/keluhan-aspirasi/') ?>"+data.bukti);
                    }
                });
            });
        });
        ...
        $(function() {
            $('.newStrukturModalButton').on('click', function(){
                ...
                $('.modal-footer button[type=submit]').html('Add');
                $('.modal-content form')[0].reset();
                $('.modal-content form').attr('action', "<?=base_url('Admin/strukturOrganisasi')?>");
            });
            ...
            $(document).on('click','.updateStrukturModalButton', function() {
                ...
                $('.modal-footer button[type=submit]').html('Save');
                $('.modal-content form').attr('action', "<?=base_url('Admin/updateStruktur')?>");
                const id = $(this).data('id');
                $.getJSON({
                    url: "<?=base_url('Admin/getUpdateStruktur/')?>"+id,
                    // data: {id : id},
                    // method: 'get',
                    // dataType: 'json',
                    success: function(data) {
