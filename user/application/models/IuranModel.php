    ...
    */
    ...
    {   
        ...
        public function tambahDataPembayaran($data){
         ...
         public function tambahDataPembayaran_iuran($data,$where){
            $this->db->where('no_tagihan', $where);
        ...
        public function tampilRiwayatPembayaran($id){
            return $this->db->query('CALL priwayat_pembayaran_iuran("'.$id.'")');
        }

         public function tampilRiwayatPembayaran_admin(){
        ...
        public function get_IuranWarga($where){
