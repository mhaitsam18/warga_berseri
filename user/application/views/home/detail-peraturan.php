		...
		<div class="row">
			<div class="col-md-10 mx-auto">
				<div class="text-justify p-5 shadow" style="height: 1000px">
					...
					<p>
						<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/peraturan/'.$peraturan['thumbnail'] ?>" class="img-thumbnail float-left mr-3" alt="<?= $peraturan['thumbnail'] ?>" style="width: 300px;"><?= $peraturan['isi'] ?>
					</p>
					<a href="<?= base_url('Home/peraturan') ?>" class="">Kembali</a>
				</div>
			</div>
		</div>
	</div>
