		...
		<div class="row">
			<div class="col-md-10 mx-auto">
				<div class="text-justify p-5 shadow" style="height: 1000px">
					...
					<p>
						<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/berita/'.$berita['thumbnail'] ?>" class="img-thumbnail float-left mr-3" alt="<?= $berita['thumbnail'] ?>" style="width: 300px;"><?= $berita['isi'] ?>
					</p>
					<a href="<?= base_url('Home/berita') ?>" class="">Kembali</a>
				</div>
			</div>
		</div>
	</div>
