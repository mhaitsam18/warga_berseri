...
<div class="main-wrapper ">
			...
			<div class="row">
				<div class="col-md-5">
					...
					<?php if (!$this->session->username) : ?>
						<a href="<?php echo base_url('Auth/') ?>" class="btn btn-main ">Masuk Sekarang <i class="ti-angle-right ml-3"></i></a>
					<?php endif; ?>
				</div>
				<!-- <div class="col-md-4">
				<div class="card" style="width: 24rem; opacity: 0.8;">
					<div class="card-body">
						...
						<form action="<?= base_url('Home/insertKeluhanAspirasi'); ?>" method="POST">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="email" class="form-control" id="email_aspirasi" name="email" placeholder="Email" value="<?= set_value('email') ?>">
				...
				<div class="card ml-3" style="width: 18rem;">
					<div class="card-body">
						...
						<h6 class="card-subtitle mb-2 text-muted">Warga Berseri</h6>
					</div>
				</div>
			</div> -->
			</div>
			...
			<div class="row ">
				<div class="col-lg-4 col-md-6">
					<div class="card p-5 border-0 rounded-top border-bottom position-relative hover-style-1">
						...
						<a href="<?php echo base_url('Profile/pendataan') ?>" class="text-color text-uppercase font-size-13 letter-spacing font-weight-bold"><i class="ti-minus mr-2 "></i>lakukan pendataan</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card p-5 border-0 rounded-top hover-style-1">
						...
						<a href="<?php echo base_url('FasilitasController/view_fasilitas') ?>" class="text-color text-uppercase font-size-13 letter-spacing font-weight-bold"><i class="ti-minus mr-2 "></i>Lihat Fasilitas</a>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="section about">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/berita/' . $berita_terkini['thumbnail'] ?>" alt="" class="img-fluid rounded shadow w-100">
				</div>
	...
	<section class="section about">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/pengumuman/' . $pengumuman_terkini['thumbnail'] ?>" alt="<?= $pengumuman_terkini['thumbnail'] ?>" class="img-fluid rounded shadow w-100">
				</div>
	...
	<section class="section about">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/peraturan/' . $peraturan_terkini['thumbnail'] ?>" alt="<?= $peraturan_terkini['thumbnail'] ?>" class="img-fluid rounded shadow w-100">
				</div>
				...
				<div class="col-lg-6">
					<div class="pl-3 mt-5 mt-lg-0">
						...
						<a href="<?php echo base_url('home/peraturan') ?>" class="btn btn-main">Lihat Peraturan<i class="fa fa-angle-right ml-2"></i></a>
					</div>
				</div>
			</div>
		</div>
	...
	<?php if ($this->session->userdata('username')): ?>
		<section class="section about">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<img src="<?= 'http://localhost/warga_berseri/admin/assets/img/notulensi/' . $notulensi_terkini['thumbnail'] ?>" alt="<?= $notulensi_terkini['thumbnail'] ?>" class="img-fluid rounded shadow w-100">
					</div>
					...
					<div class="col-lg-6">
						<div class="pl-3 mt-5 mt-lg-0">
							...
							<a href="<?php echo base_url('home/notulensi') ?>" class="btn btn-main">Lihat Notulensi<i class="fa fa-angle-right ml-2"></i></a>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		function initMap() {
			...
			for (var i = 0; i < markers.length; i++) {
				...
				// var icon = {
				// 	url: "<?= base_url('assets_chart/maps_merah.png') ?>", // url
				...
				// 	position: {
				// 		lat: parseFloat(tanda['long']),
				// 		lng: parseFloat(tanda['lat'])
				// 	},
				// 	map: map,
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD0IiE8DDVHIZJYCT1jmcaJpXtjP6Dftvg&callback=initMap&libraries=&v=weekly" async>
	</script>