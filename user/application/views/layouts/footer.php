...
<!-- <?php if ($this->uri->segment(1) == "Home" && $this->uri->segment(2) == "" || $this->uri->segment(1) == "Home" && $this->uri->segment(2) == "index") { ?>
  
<?php } ?> -->
<?php if ($this->uri->segment(2) == "strukturOrganisasi") { ?>
  <script src="<?php echo base_url(); ?>asset_chart/go.js"></script>
  <script>
    function init() {
