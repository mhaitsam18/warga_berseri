	...
	<div class="container-fluid">
		...
		<div class="collapse text-center navbar-collapse" id="navbarsid">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item"><a class="nav-link" href="<?php echo base_url('Home/keluhanAspirasi') ?>">Keluhan & Aspirasi</a></li>
				<li class="nav-item"><a class="nav-link" href="<?php echo base_url('Home/strukturOrganisasi') ?>">Struktur Organisasi</a></li>
				<!-- <li class="nav-item"><a class="nav-link" href="<?php echo base_url('Kendaraan/') ?>">Pendataan Kendaraan</a></li> -->
